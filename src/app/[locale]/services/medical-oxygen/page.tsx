...
export default function MedicalOxygenPage() {
  const t = useTranslations('oxygenPage');
  ...
  return (
    <div className="pt-20">
      ...
      {/* Sub-services: Hydrostatic, Refilling, Trading, Refurbishing */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollSection>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {['hydrostatic', 'refilling', 'trading', 'refurbishing'].map((key) => (
                <div
                  key={key}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollSection className="flex flex-col lg:flex-row-reverse gap-12 items-center">
            ...
            <div className="w-full lg:w-3/5">
              ...
              <ul className="space-y-3">
                {['compliance1', 'compliance2', 'compliance3'].map((key) => (
                  <li key={key} className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-gold shrink-0 mt-0.5" />
                    <span className="text-gray-600">{t(key)}</span>
                  </li>
